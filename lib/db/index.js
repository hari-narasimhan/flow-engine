...
module.exports = {
  local: {
    createClient: createLocalDBClient,
    createCursor: createLocalDBCursor
  },
  remote: {
    createClient: createRemoteDBClient,
    createCursor: createRemoteDBCursor,
    getCursor: getRemoteDBCursor,
    closeCursor: closeRemoteDBCursor,
    readCursor: readRemoteDBCursor,
    executeRaw: executeRemoteDBRaw,
    createTransaction: createRemoteDBTransaction,
    commitTransaction: commitRemoteDBTransaction,
    rollbackTransaction: rollbackRemoteDBTransaction,
    executeInTransaction: executeInRemoteDBTransactionContext
  }
}
