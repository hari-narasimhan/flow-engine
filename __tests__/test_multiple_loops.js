...
const complexFlow = {
  ...
  connections: [
    ...
    { source: 'ninth', target: 'tenth' },
    { source: 'tenth', target: 'eleventh', path: 'loop' },
    { source: 'eleventh', target: 'tenth' },
    { source: 'tenth', target: 'twelve', path: 'end' }
  ]
}
const context = {}
